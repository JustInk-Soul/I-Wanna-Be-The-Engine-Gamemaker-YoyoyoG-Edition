...
// Sets whether the player wraps around the een for a smooth transition to the next room (this requires both the room sizes to be the same), can be changed in creation code
