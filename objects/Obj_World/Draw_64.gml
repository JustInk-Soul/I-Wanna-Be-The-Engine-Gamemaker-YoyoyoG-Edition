/// @description Draw pause een/debug overlay

// Draw pause een

if (global.gamePaused) {
    draw_sprite(global.pauseSpr_,-1,0,0);
    
    draw_set_color(c_black);
    draw_set_alpha(0.4);
    
    draw_rectangle(-1,-1,display_get_gui_width(),display_get_gui_height(),0); // Draw a rectangle over the pause een to darken it
...
// Draw debug mode text when we're on the title een
