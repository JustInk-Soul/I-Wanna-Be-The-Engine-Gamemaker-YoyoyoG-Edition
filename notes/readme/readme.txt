...
- Pause een that shows deaths/time with volume controls
...
- Several engine options for things you might want to customize for your game (such as enabling/disabling death music) in the "Engine_Options" ipt

Important notes
- To set what music you want a room to play, change the "Music_Get" ipt. If you want something to stop music, use the "Music_Stop" ipt.
...
- Make sure to set the "global.debugMode" variable in the "Engine_Options" ipt to "false" before releasing your game, otherwise debug keys will still work.
- Make sure to set the "MD5_STR_ADD" string in the "Engine_Options" ipt to something unique to your game to make saves harder to modify. This can be set to anything you want it to be, but it should be pretty hard to predict as it's kind of similar to a password.
